...
for(let value of this.etudArra){
  ...
  doc.addImage(imgData, 'JPEG', 145, 10, 60, 40)
   doc.text(90, 70, 'releve de note')
   doc.text(10, 70,nom +' '+prenom)
   //les matieres 
  doc.text(10,85,'algebre 1')
  doc.text(10,95,'analyse  1')
  doc.text(10,105,'resultat : ')
  doc.text (10,120,'algorithmique') 
  doc.text (10,130,'langageC') 
  doc.text (10,140,'bureautique')
  doc.text(10,150,'resultat : ')
  doc.text(10,165,'francais')
  doc.text(10,175,'anglais')
  doc.text(10,185,'droit d`entreprise')
  doc.text(10,195,'resultat : ')
  doc.text(10,210,'electronique analogique')
  doc.text(10,220,'informatique industrielle')
  doc.text(10,230,'architecture des ordinateur')
  doc.text(10,240,'resultat : ')


// les notes 
   doc.text(120,85,'16') // dif algebre 1 
  doc.text(120,95,'17')
  doc.text(120,105,'16,5')
  doc.text (120,120,'15')  //modif algorith
  doc.text (120,130,'18') 
  doc.text (120,140,'17')
  doc.text(120,150,'16,33 ')
  doc.text(120,165,'18')
  doc.text(120,175,'18')
  doc.text(120,185,'17')
  doc.text(120,195,'17,66 ')
  doc.text(120,210,'17')
  doc.text(120,220,'17')
  doc.text(120,230,'15') //modif  architecture des ordinateur 
  doc.text(120,240,'16,33')
  ...
  doc.line(110, 75, 110, 245)
   ...
   doc.save('releve de note '+nom+' '+prenom+' .pdf')
